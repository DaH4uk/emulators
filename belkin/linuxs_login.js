...
function show_mlang()
{
	dw('<img name=link1 style="cursor:pointer" src="b_en1.gif" onMouseover="document.link1.src=Pic1_1.src" onMouseout="document.link1.src=Pic1.src" onmousedown="window.location.assign(\'../En/login.html\');">')	
	dw('<img name=link3 style="cursor:pointer" src="b_es1.gif" onMouseover="document.link3.src=Pic2_1.src" onMouseout="document.link3.src=Pic2.src" onmousedown="window.location.assign(\'../En/login.html\');">')
	dw('<img name=link2 style="cursor:pointer" src="b_fr1.gif" onMouseover="document.link2.src=Pic3_1.src" onMouseout="document.link2.src=Pic3.src" onmousedown="window.location.assign(\'../En/login.html\');">')
	dw('<img name=link4 style="cursor:pointer" src="b_de1.gif" onMouseover="document.link4.src=Pic4_1.src" onMouseout="document.link4.src=Pic4.src" onmousedown="window.location.assign(\'../En/login.html\');">')
	dw('<img name=link6 style="cursor:pointer" src="b_du1.gif" onMouseover="document.link6.src=Pic5_1.src" onMouseout="document.link6.src=Pic5.src" onmousedown="window.location.assign(\'../En/login.html\');">')
	dw('<img name=link5 style="cursor:pointer" src="b_it1.gif" onMouseover="document.link5.src=Pic6_1.src" onMouseout="document.link5.src=Pic6.src" onmousedown="window.location.assign(\'../En/login.html\');">')	
	dw('<img name=link7 style="cursor:pointer" src="b_sc1.gif" onMouseover="document.link7.src=Pic7_1.src" onMouseout="document.link7.src=Pic7.src" onmousedown="window.location.assign(\'../En/login.html\');">')
	dw('<img name=link8 style="cursor:pointer" src="b_tc1.gif" onMouseover="document.link8.src=Pic8_1.src" onMouseout="document.link8.src=Pic8.src" onmousedown="window.location.assign(\'../En/login.html\');">')
	dw('<img name=link9 style="cursor:pointer" src="b_jp1.gif" onMouseover="document.link9.src=Pic9_1.src" onMouseout="document.link9.src=Pic9.src" onmousedown="window.location.assign(\'../En/login.html\');">')
	dw('<img name=link10 style="cursor:pointer" src="b_kr1.gif" onMouseover="document.link10.src=Pic10_1.src" onMouseout="document.link10.src=Pic10.src" onmousedown="window.location.assign(\'../En/login.html\');">')
}
