...
function showHead(wanStatus,helpItem,isRouter,isPS)
{
    ...
    document.write(strHtml); 
	      ...
	      strHtml =            	'<td height="28" align="left" nowrap class="top_nav" valign=middle> '+
            		    		...
            		    		'| &nbsp;<a href="javascript:top.location.href=\'help_login.html\';" class="top_nav">'+show2+'</script></a>&nbsp;';
    document.write(strHtml);        						 
	if(helpItem =='Login' )
	{
...
function showmenu(menuSection,menuItem,isRouter,isPS,isAPmode)
{
    ...
    if(isAPmode =='0')
    {
    	...
    	{ 
    		printMenuSection('login_lan_main.html', show8, white); 
        	printMenuItem('login_lan_sett.html', show9, white1, darkgrey);
        	printMenuItem('login_lan_dhcp.html', show10, white1, darkgrey);
		}
		...
		{	
			printMenuSection('login_wan_menu.html', show11, white);    		
    		printMenuItem('login_wan_conn.html', show12, white1, darkgrey);
    		printMenuItem('login_wan_dns.html', show13, white1, darkgrey);
    		printMenuItem('login_wan_mac.html', show14, white1, darkgrey);
        }
	}
	...
	// router or ap mode
		...
		{
			printMenuSection('login_wls_main.html', show17, white);
    		printMenuItem('login_wls_chan.html', show18, white1, darkgrey);
    		printMenuItem('login_wls_encr.html', show19, white1, darkgrey);
			printMenuItem('login_wls_wps.html', show21, white1, darkgrey);
     		printMenuItem('login_wls_apt.html', show20, white1, darkgrey);
     		//printMenuItem('wls_wds.html', show23, white1, darkgrey);
     	    printMenuItem('login_wls_acl.html', show22, white1, darkgrey);
      	}
      } 	      	
    //router mode    			
    if(isAPmode=='0') 
    {   	
		...
		{
         	printMenuSection('login_fw_main.html', show24, white);
         	
    		//printMenuItem('fw_gtwy.html', 'Application Gateways', black, white);
          	printMenuItem('login_fw_virt.html', show25, white1, darkgrey);
          	printMenuItem('login_fw_acl.html', show26, white1, darkgrey);
          	printMenuItem('login_fw_mac.html', show27, white1, darkgrey);
          	printMenuItem('login_fw_dmz.html', show28, white1, darkgrey);
          	printMenuItem('login_ddns.html', show15, white1, darkgrey);
          	printMenuItem('login_fw_ping.html', show29, white1, darkgrey);
        	printMenuItem('login_fw_sec.html', show30, white1, darkgrey);
        }
	} 
        ...
        // router or ap mode
      	...
      	{
      		printMenuSection('login_ut_main.html', show31, white);
  			printMenuItem('login_ut_reset.html', show33, white1, darkgrey);
          	printMenuItem('login_ut_facty.html', show35, white1, darkgrey);
          	printMenuItem('login_ut_save.html', show36, white1, darkgrey);
          	printMenuItem('login_ut_prev.html', show37, white1, darkgrey);
          	printMenuItem('login_ut_firew.html', show38, white1, darkgrey);
        	if(isAPmode=='0')
    		{
    			printMenuItem('login_ut_sys.html', show39,  white1, darkgrey);
        	}
        	else
        	{
        		printMenuItem('login_utb_sys.html', show39,  white1, darkgrey);
        	}
        }
