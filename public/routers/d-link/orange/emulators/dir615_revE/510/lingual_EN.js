var _Advanced_01 ="When feature is enabled, your internet traffic will be protected by a security ready DNS server. This feature provides Anti-Phishing to protect your Internet connection from fraud and navigation improvements such as auto-correction of common URL typos.";
var _Advanced_02 ="When DNS Relay is enabled along with Advanced DNS feature,your workstations on the network that are obtaining an IP address from router's DHCP server will obtain 192.168.0.1 (router's IP address). However, traffic will still be protected.";
var _Advanced_03 ="Although Advanced DNS feature is enabled, DNS IP address of your workstation can still be modified to the DNS server IP you desire. Please note that the router does not dictate the DNS name resolution when DNS IP address is configured on the workstation.";
var _Advanced_04 ="If you selected this option and have VPN or Intranet setup in your network, you can disable Advanced DNS service if you experience connection difficulties.";
var bwn_ict_dns ="Advanced DNS Service";
var bwn_msg_Modes_dns ="Advanced DNS is a free security option that provides Anti-Phishing to protect your Internet connection from fraud and navigation improvements such as auto-correction of common URL typos.";
var ta_EUPNP_dns ="Enable Advanced DNS Service";
var _dlinkdns ="Advanced DNS";
var new_bwn_mici_usb ="My USB type is";
var _tkip_11n ="Can't choose TKIP when 802.11n only.!!";
var bln_title_guest_use_shareport ="SharePort For Guest Zone";
var bwn_mici_guest_use_shareport ="Enable SharePort For Guest Zone";
var _authword ="Enter the correct password above and then type the characters you see in the picture below.";
var _regenerate ="Regenerate";
...
var bwn_intro_usb ="Use this section to configure your USB port. There are several configurations to choose from: Network USB, 3G USB Adapter and WCN Configuration.";
...
var logs_LW39b_email ="The Email Now button is disabled because Email Notification is not enabled on <a href=\"tools_email.htm\" onclick=\"return jump_if();\" shape=\"rect\">Tools &rarr; Email</a> screen.";
var LV3 ="Use HTTPS";
...
var GW_NAT_TRIGGER_PORT ="Trigger Ports";
...
var bws_msg_WEP_4 ="If you choose the WEP security option this device                                         will <strong>ONLY</strong> operate in <strong>Legacy Wireless mode (802.11B/G)</strong>.                                         This means you will <strong>NOT</strong> get 11N performance due to the fact that WEP                                         is not supported by the Draft 11N specification.";
...
var _upgintro ="The router will now be reprogrammed using the uploaded firmware file. Please wait <span id=\"timeleft\"></span>&nbsp;seconds for this process to complete, after which you may access these web pages again. Pressing reload or back on your browser may cause this operation to fail.";
...
var ta_wcn_note ="Note: refer to <a href=\"support_tools.htm#wcn\" onclick=\"return jump_if();\" style=\"white-space: nowrap;\">Help -> Tools</a> for possible limitations regarding this feature.";
var tps_intro5 ="To use the shared printer from this computer, follow the setup instructions found in <a href=\"support_internet.htm#PS\" onclick=\"return jump_if();\" style=\"white-space: nowrap;\">Help -> Home -> Printer Wizard</a>.";
...
var GW_INET_ACCESS_DROP_ACCESS_CONTROL_MAC ="Internet access control dropped packet from %v:%u[%s] to %v:%u (protocol %u)";
...
var wwl_s4_intro_za2 ="- Between 8 and 64 characters (A longer WPA key is more secure than a short one)";
...
var num_1066 ="The LAN address that you want to reserve.";
...
var help670 ="RIP";
var IPPPPLCP_SET_LOCAL_OPTIONS ="LCP sets local options: ACCM: %lx, ACFC: %u, PFC: %u, MRU: %u";
...
var bwsAT ="Authentication Timeout";
...
var IPPPPLCP_SET_REMOTE_OPTIONS ="LCP sets remote options: ACCM: %lx, ACFC: %u, PFC: %u, MRU: %u";
var tt_Mar ="Mar";
...
var bd_intro ="Use this section to configure the built-in DHCP Server to assign IP addresses to the computers on your network.";
...
var as_RTSP ="RTSP";
var anet_wp_auto2 ="Auto 10/100Mbps";
...
var bwn_intro_ICS ="Use this section to configure your Internet Connection type. There are several connection types to choose from: Static IP, DHCP, PPPoE, PPTP and L2TP. If you are unsure of your connection method, please contact your Internet Service Provider.";
...
var tf_really__FWF ="Do you really want to reprogram the device using the firmware file";
var tt_time_16 ="3 pm";
...
var num_501_12 ="Click this button to start creating a new access control policy.";
...
var te_title_EmLogg ="Email log when FULL or on Schedule";
...
var help481 ="Decibels relative to isotropic radiator";
...
var rb_wait ="Please wait <span id=\"timeleft\"></span>&nbsp;seconds.";
...
var ns_intro ="Use this section to configure the internal network settings of your router and also to configure the built-in DHCP Server to assign IP addresses to the computers on your network. The IP Address that is configured here is the IP Address that you use to access the Web-based management interface. If you change the IP Address here, you may need to adjust your PC's network settings to access the network again.";
...
var help71 ="Select a filter that controls access as needed for this rule. If you do not see the filter you need in the list of filters, go to the <a href=\"Inbound_Filter.htm\"> Advanced&nbsp;&rarr;&nbsp;Inbound&nbsp;Filter</a> screen and create a new filter.";
var KR20 ="The Wireless Device PIN field cannot be blank";
var KR25 ="Session Time-Out";
var hhag_30 ="Select a schedule for when the rule will be enabled. If you do not see the schedule you need in the list of schedules, go to the <a href=\"tools_schedules.htm\" onclick=\"return jump_if();\">Tools &rarr; Schedules</a> screen and create a new schedule.";
...
var help900 ="After configuring the router for dynamic DNS, you can open a browser and navigate to the URL for your domain (for example <code>http://www.mydomain.info</code>) and the router will attempt to forward the request to port 80 on your LAN. If, however, you do this from a LAN-side computer and there is no virtual server defined for port 80, the router will return the router's configuration home page. Refer to the <a href=\"adv_virtual.htm\">Advanced &rarr; Virtual&nbsp;Server</a> configuration page to set up a virtual server.";
var hhta_831 ="Select a filter that controls access as needed for this admin port. If you do not see the filter you need in the list of filters, go to the <a href=\"Inbound_Filter.htm\" onclick=\"return jump_if();\">Advanced &rarr;&nbsp;Inbound&nbsp;Filter</a> screen and create a new filter.";
var GW_WISH_RULES_HOST1_PORT ="'%s': Host 1 port start, %u, must be less than host 1 port end, %u";
var help22 ="Select a filter that controls access as needed for this virtual server. If you do not see the filter you need in the list of filters, go to the <a href=\"Inbound_Filter.htm\"> Advanced&nbsp;&rarr;&nbsp;Inbound&nbsp;Filter</a> screen and create a new filter.";
...
var help72 ="Select a schedule for the times when this rule is in effect. If you do not see the schedule you need in the list of schedules, go to the <a href=\"tools_schedules.htm\"> Tools&nbsp;&rarr;&nbsp;Schedules</a> screen and create a new schedule.";
var hhpt_sch ="Select a schedule for when the service will be enabled. If you do not see the schedule you need in the list of schedules, go to the <a href=\"tools_schedules.htm\" onclick=\"return jump_if();\">Tools &rarr; Schedules</a> screen and create a new schedule.";
var wprn_tt2 ="Enable raw TCP port printing from the <em>Print Server?</em> page under the <em>Tools</em> submenu.";
var help53 ="Select a schedule for when this rule is in effect. If you do not see the schedule you need in the list of schedules, go to the <a href=\"tools_schedules.htm\"> Tools&nbsp;&rarr;&nbsp;Schedules</a> screen and create a new schedule.";
...
var help38 ="Allows FTP clients and servers to transfer data across NAT. Refer to the <a href=\"adv_virtual.htm\">Advanced&nbsp;&rarr;&nbsp;Virtual&nbsp;Server</a> page if you want to host an FTP server.";
...
var help30 ="Requests may be redirected to the \"Forbidden\" page if web access for the LAN machine is restricted by an Access Control Rule. Add the WAN-side identity (WAN-side IP-address of the router or its dynamic DNS name) on the <a href=\"adv_filters_url.htm\"> Advanced&nbsp;&rarr;&nbsp;Web&nbsp;Filter</a> screen to work around this problem.";
...
var help23 ="Select a schedule for when the service will be enabled. If you do not see the schedule you need in the list of schedules, go to the <a href=\"tools_schedules.htm\"> Tools&nbsp;&rarr;&nbsp;Schedules</a> screen and create a new schedule.";
...
var haf_intro_2 ="See also <a href=\"adv_virtual.htm\"> Virtual Server</a>, <a href=\"../Advanced/Gaming.shtml\">Port Forwarding</a>, <a href=\"../Advanced/Special_Applications.shtml\"> Application Rules</a>, and <a href=\"../Advanced/Network.shtml\">UPnP</a> for related options.";
...
var help167 ="Specify the LAN IP address of the LAN computer that you want to have unrestricted Internet communication. If this computer obtains its address Automatically using DHCP, then you may want to make a static reservation on the <a href=\"lan.htm\">Basic &rarr; Network&nbsp;Settings</a> page so that the IP address of the DMZ computer does not change.";
...
var num_1044a ="Note, however, if the AP's settings specify \"DHCP (Dynamic)\" Address, and the <span>rou</span><span>ter</span>'s DHCP server assigns a domain name to the AP, that domain name will override any name you enter here.";
...
var help802 ="If you provided email information with the <a href=\"tools_email.htm\">Tools&nbsp;-&gt;&nbsp;Email</a> screen, clicking the <span class=\"button_ref\">Email Now</span> button sends the router log to the configured email address.";
...
var help831 ="Select a filter that controls access as needed for this admin port. If you do not see the filter you need in the list of filters, go to the <a href=\"Inbound_Filter.htm\" onclick=\"return jump_if();\">Advanced &rarr; Inbound&nbsp;Filter</a> screen and create a new filter.";
var help831_1 ="Select a filter that controls access as needed for this admin port. If you do not see the filter you need in the list of filters, go to the <a href=\"Inbound_Filter.htm\" onclick=\"return jump_if();\">Advanced &rarr; Inbound&nbsp;Filter</a> screen and create a new filter.";
var help872 ="If you selected the On Schedule option, select one of the defined schedule rules. If you do not see the schedule you need in the list of schedules, go to the <a href=\"tools_schedules.htm\">Tools&nbsp;-&gt;&nbsp;Schedules</a> screen and create a new schedule.";
...
var help887 ="Some firmware upgrades reset the configuration options to the factory defaults. Before performing an upgrade, be sure to save the current configuration from the <a href=\"tools_system.htm\">Tools&nbsp;-&gt;&nbsp;System</a> screen.";
var help890 ="When this option is enabled, an email will be sent to the email address configured in the email section whenever new firmware is available. You must have Email Notification enabled from the <a href=\"tools_email.htm\">Tools&nbsp;-&gt;&nbsp;Email</a> screen.";
...
var rb_change ="If you changed the IP address of the router <br /> you will need to change the IP address in your <br /> browser before accessing the configuration Web site again.";
...
var hhsl_lmail ="You can also have the log mailed to you periodically. Refer to <a href=\"tools_email.htm\" onclick=\"return jump_if();\">Tools &rarr; EMail</a>.";
...
var ta_RAIF ="Remote Admin <a href=\"Inbound_Filter.htm\" onclick=\"return jump_if();\">Inbound Filter</a>";
...
var tf_msg_FWUgReset ="Some firmware upgrades reset the configuration options to the factory defaults. Before performing an upgrade, be sure to save the current configuration from the <a href=\"tools_system.htm\" onclick=\"return jump_if();\">Tools&nbsp;-&gt;&nbsp;System</a> screen.";
...
var ap_intro_noreboot ="Press the button below to continue configuring the router if the previous page doesn't restore in <span id=\"timeleft\"></span>&nbsp; seconds.";
...
var rd_p_2 ="If the login page does not appear, click <a href=\"/login.html\">this link</a>.";
...
var aa_AT_2 ="Others";
var _copyright ="Copyright &copy; 2004-2009 DLink, Inc.";
...
var bwn_IF ="WAN Ping <a href=\"Inbound_Filter.htm\" onclick=\"return jump_if();\">Inbound Filter</a>";
...
var at_alert_1 ="Max transmission rate should be between 8 kbps and 100 Mbps, inclusive.";
...
var at_Prot__1 ="Select Protocol";
var at_Prot_0 ="ANY";
...
var hhav_sch ="Select a schedule for when the virtual server will be enabled. If you do not see the schedule you need in the list of schedules, go to the <a href=\"tools_schedules.htm\" onclick=\"return jump_if();\">Tools &rarr; Schedules</a> screen and create a new schedule.";
var hhav_filt ="Select a filter that restricts the Internet hosts that can access this virtual server to hosts that you trust. If you do not see the filter you need in the list of filters, go to the <a href=\"Inbound_Filter.htm\" onclick=\"return jump_if();\"> Advanced &rarr; Inbound&nbsp;Filter</a> screen and create a new filter.";
...
var hhwf_xref ="Use with <a href=\"support_adv.htm#Access_Control\" onclick=\"return jump_if();\">Access Control</a>.";
...
var num_225ap ="The gateway address is not in the LAN subnet";
var num_226ap ="IP address or subnet mask is badly formatted";
...
var help215 ="Note that WCN only sets a few of the wireless options. You will still need to go to the <a href=\"wireless.htm\">Wireless Settings</a> page to set other wireless options such as Super G Mode and transmission rate.";
...
var help359 ="Super G Turbo Modes must use channel 6 for communication. For Super G with Static Turbo, <span class=\"option\">802.11 Mode</span> must be set to 802.11g. For proper operation, RTS threshold and Fragmentation Threshold on the <a href=\"adv_wlan_perform.htm\">Advanced &rarr; Advanced Wireless</a> screen should both be set to their default values.";
...
var LT291 ="This area of the screen reflects configuration settings from the <a href=\"wireless.htm\">Setup &rarr; Wireless Settings</a> page. The <span class=\"option\">MAC Address</span> is the factory-assigned identifier of the wireless card.";
...
var LT290wifisc ="This area of the screen reflects configuration settings from the <a href=\"wireless.htm\">Setup &rarr; Wireless Settings</a> page, the <a href=\"adv_wish.htm\">Advanced &rarr; WISH</a> page and the <a href=\"wireless.htm\">Advanced &rarr; Wi-Fi Protected Setup</a> page. The <span class=\"option\">MAC Address</span> is the factory-assigned identifier of the wireless card.";
...
var LT290 ="This area of the screen reflects configuration settings from the <a href=\"wireless.htm\">Setup &rarr; Wireless Settings</a> page and the <a href=\"adv_wish.htm\">Advanced &rarr; WISH</a> page. The <span class=\"option\">MAC Address</span> is the factory-assigned identifier of the wireless card.";
...
var IPV6_TEXT13 ="Select this option if you require any wireless device attempting to communicate with the router to provide the encryption key needed to access the network before being allowed to communicate with the DIR-615.";
...
var IPV6_TEXT15 ="The Key Types that are supported by the DIR-615 are HEX (Hexadecimal) and ASCII (American Standard Code for Information Interchange.) The Key Type can be changed to suit an existing wireless network or to customize your wireless network.";
...
var IPV6_TEXT21 ="DIR-615 supports two different cipher types when WPA is used as the Security Type. These two options are TKIP (Temporal Key Integrity Protocol) and AES (Advanced Encryption Standard).";
...
var IPV6_TEXT25 ="This will be needed by your wireless clients in order to communicate with your DIR-615, when PSK is selected. Enter 8 to 63 alphanumeric characters. Be sure to write this Passphrase down as you will need to enter it on any other wireless devices you are trying to add to your network.";
...
var IPV6_TEXT67 ="Use this section to configure the internal network settings of your router.";
...
var TEXT009 ="obj_word + \" conflict with another public port.\"";
var TEXT010 ="obj_word + \" conflict with another private port.\"";
...
var TEXT070 ="IPv6 Connetcion Information";
...
var MSG044 ="Pure 802.11n mode doesn't support WEP.";
var MSG045 ="Pure 802.11n mode doesn't support TKIP.";
...
var ADV_DNS_DESC3 ="Your search results are powered by Yahoo. The search function provides you with a much more fluid browsing experience. When a site cannot be reached, or a site does not exist, we will provide you with search suggestions instead of the generic error message displayed by your browser. We also automatically correct some of the common typos users make in the address bar. The typo-correction feature only works for top level domains that have been misspelled, such .cmo and .ogr. Sometimes you might be mis-directed to the search results page. If you clicked on a link in a spam email it is quite possible that the site has been disabled for abuse. Because the site no longer exists you may receive our search page. ";
var _clearlp ="Clear Language Pack";
var _clearlpmsg ="Clear the language pack?";
var bwn_msg_Modes_nat_double ="Select AP Mode if the device is connected to a local network downstream from another router.";
