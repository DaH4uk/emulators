lang = {
    ...
    "PortInUse": "Such external port is already in use",
    ...
    "nstIp": "IP",
    "msec": "msec",
    "PortsInUse": "One of the external port is already in use",
    ...
    "wanGwifErr": "Not set the default gateway. Internet access can be absent .",
    ...
    "printServerSect": "Print-server settings",
    "dhcpModeEn": "Enable",
    ...
    "clickOKCancel": "Click OK to go to the edit page, or Cancel to exit the wizard.",
    "ipfltSectIP2": "You can specify <b>a single IP address</b>, or <b>a subnet IP address</b> (for example, 10.10.10.10/24).",
    ...
    "read_more": "Read more",
    "checkOutRange": "Initial port can not be greater than the final. Check out the range",
    ...
    "portUsedInVS": "is already being used in the virtual servers configuration. Please, set a different value.",
    "airSave": "Save",
    ...
    "DROP": "DROP",
    "printServerMake": "Make and model",
    ...
    "TR69DescText": "On the <b>TR-069</b> Client page, you can configure the router for communication with a remote Auto Configuration Server (ACS).",
    ...
    "dhcpModeDis": "Disable",
    "passwInvalidLogin": "Password should not coincide with the login",
    "status": "Status",
    ...
    "dlna_name": "DLNA server name",
    "staListtx_bytes": "Tx (bytes)",
    "disable": "Disabled",
    "ripOpMode": "Operation",
    "advanced": "Advanced settings",
    "airAddToWifi": "Ban by MAC to Wi-Fi filter",
    "security": "Security",
    ...
    "menu_tranSettings": "Transmission settings",
    ...
    "proxy": "Proxy",
    "ripNoteMessage": "RIP can not be configured on the WAN interface which has NAT enabled",
    "button_browse": "Browse",
    "transetLabel": "Transmission settings",
    ...
    "transetMainDir": "Torrents directory",
    "menu_dns": "DNS",
    ...
    "transetDeviceDir": "USB-storage path",
    ...
    "transetRpcPort": "Web-interface port",
    ...
    "transetOpenFilesLimit": "Open files limit",
    "transetDescText": "Using the web-based interface of the built-in Transmission torrent client you can manage the process of downloading files to the USB storage connected to the router.",
    "transetPeerLimit": "Peer limit",
    "wzwifiAttWAN": "To access the Internet, please also configure a WAN connection!",
    "broadcastComment": "This function allows you to enable or disable broadcasting wireless network without disconnecting the radio router. Can be used in conjunction with a \"Сlient Wi-Fi\"",
    ...
    "transetWebIface": "Web-interface page",
    "g3LTE_connection_success": "3G/LTE-modem plugged",
    "passwErrors": "Several fields contain errors",
    "menu_transmission": "Transmission",
    ...
    "rmtAccessLabel_v4": "Remote access configuration IPv4",
    "airUmount": "Unmount storage",
    ...
    "airYou": "You",
    "basicCFEblock": " Restrict access to the Web-interface",
    "wanStatusUnconfigured": "Unconfigured",
    "rmtAccessLabel_v6": "Remote access configuration IPv6",
    "menu_wan": "Connections",
    "airWiFiScannerDesc": "Viewing wireless hotspots",
    "airReseting": "Reseting...",
    "airWSignal": "Signal",
    "tracerouteDescText": "On the <b>Traceroute</b> page, you can determine the route of data transfer to a host via the traceroute utility.",
    "ddnsFullHostName": "Full host name",
    ...
    "rmtAccessExistRule": "Such rule is already exist!  \tGet back to editing?",
    ...
    "wifiWEPKeyWrong64": "Key length must be 5 characters. Empty key is not allowed!",
    "transetNoDevice": "Memory is not connected",
    ...
    "wanNeedPINMesPart1LTE": "The 3G/LTE modem is blocked.<br>To create a 3G connection, you need",
    ...
    "wifiWEPKeyWrong128": "Key length must be 13 characters. Empty key is not allowed!",
    ...
    "airRedirectIp": "If there was no automatic transition, change your local settings and click the link below",
    ...
    "wanNoUsbLTEModemAvail": "A connection of this type established via a 3G/LTE modem. Check if your 3G/LTE modem is connected.",
    "ddnsWrongHostName": "Wrong format hostname.\n Write hostname without service name.\n For example, for xxxxx.DynDdns.com, hostname - xxxxx",
    ...
    "wifiWEPKeyWrongHEXSize64": "Key length must be 10 characters. Empty key is not allowed!",
    "wanStatuscableDisconnect": "Cable is not connected",
    ...
    "help_menu_ftp": "On the <b>FTP</b> page, you can enable the built-in FTP server of the router to provide access to the USB storage for users of your LAN.",
    ...
    "tr69LabelConn": "ConnectionRequest Settings",
    "ping_v6": "IPv6",
    ...
    "passwWrongPass": "Password contains invalid characters",
    ...
    "passwConfirmCirill": "Password and confirm password should not contain Cyrillic alphabet!",
    ...
    "wifiWEPKeyWrongHEXSize128": "Key length must be 26 characters. Empty key is not allowed",
    "help_menu_g3LTEinfo": "On the <b>Information</b> page, you can view data on the 3G/LTE modem connected to the router.",
    "help_menu_tr69": "On the <b>TR-069</b> Client page, you can configure the router for communication with a remote Auto Configuration Server (ACS).",
    ...
    "help_menu_dlna": "DLNA — a set of standards for sharing of digital media between compatible multimedia devices.",
    ...
    "airWiFiDesc5G": "Wireless network is not secure (5GHz)",
    "statpppoe": "PPPoE + Static IP",
    ...
    "airWiFiDesc2.4G5G": "Wireless network is not secure (2.4GHz and 5GHz)",
    ...
    "airControl": "Control",
    "help_menu_samba": "On the <b>Samba page</b>, you can enable the built-in Samba server of the router to provide access to the USB storage for users of your LAN.",
    "inetfail": "The specified host is not available. Perhaps the problem in the node. Try a different well-known URL and click \"Recheck\"",
    ...
    "returnWizard": "To open the wizard",
    "airPasswd": "Password",
    "tr69Interval": "Interval",
    "help_ex_menu_traceroute": "To determine the route, enter the name or IP address of a host in the <b>Host</b> field. Click the <b>Start</b> button. After a while, the results will be displayed on the page.",
    ...
    "airBtnStart": "Start",
    "airWiFiDesc2.4G": "Wireless network is not secure (2.4GHz)",
    ...
    "help_ex_menu_ftp": "You can enable the FTP server only when a USB storage is connected to the router (in this case, the <b>Connected</b> value is displayed in the <b>USB storage</b> field). Select the <b>Enable</b> checkbox; if needed, change the router's port used by the FTP server in the <b>Port</b> field (by default, the standard port <b>21</b> is specified). Then click the <b>Change</b> button.<br />To allow access to the content of the USB storage for users of your LAN, proceed to the <b>USB storage / Users</b> page and create needed accounts.<br />To disable the built-in FTP server of the router, deselect the <b>Enable</b> checkbox and click the <b>Change</b> button.",
    "airBtnNext": "Next »",
    "airMenuFirmware": "Update firmware...",
    "airEnter": "Enter",
    "enable_auto_check": "Check for updates automatically",
    "usb_not_exist": "USB not exist",
    "airLTEDesc": "LAN subnet coincides with modem subnet",
    "airLTEDesc2": "Need to change the LAN settings",
    ...
    "clientScanDate": "Wireless network range",
    "devInfoLanIpv4": "LAN IPv4",
    "typeproto": "Protocol type",
    "version": "Version",
    "tr69ConnReqPort": "Request port",
    ...
    "nstStateDown": "Down",
    "devInfoLanIpv6": "LAN IPv6",
    "tr69ConnReqPath": "Request path",
    "firmware_titlemsg": "The firmware of your device is being updated!",
    ...
    "urlfOff": "URL-filter off. In order to use rules you need to enable URL-filter",
    ...
    "menu_flow_control": "Flow Control",
    ...
    "Kb": "Kbit",
    "help_menu_traceroute": "On the <b>Traceroute</b> page, you can determine the route of data transfer to a host via the traceroute utility.",
    ...
    "printServerStatus": "Enable/Disable print-server",
    "passwEmptyPass": "Empty password",
    ...
    "passwChangePass": "Change password",
    ...
    "help_menu_tranSettings": "Using the web-based interface of the built-in Transmission torrent client you can manage the process of downloading files to the USB storage connected to the router.",
    ...
    "wifiBroadcastEnable_5": "Enable broadcasting network 5GHz",
    ...
    "staListmac": "MAC",
    "broadcastSettings": "Configure their network",
    "airNotConn": "Please, create a connection",
    "dlna_ignore_storage": "Make settings without storage",
    "wifiBroadcastEnable_24": "Enable broadcasting network 2,4GHz",
    ...
    "clientMasterBroadcast_24": "Broadcasting their network 2,4GHz",
    ...
    "clientMasterBroadcast_5": "Broadcasting their network 5GHz",
    "commonEnableWds_24": "Broadcast wireless network 2,4GHz",
    "mtnet_passError": "The password must contain only English letters and numbers!",
    "basicModeComment": "When changing mode from \"B\"/\"G\" on any of the modes with \"N\" is recommended to re-tune security!",
    "commonEnableWds_5": "Broadcast wireless network 5GHz",
    ...
    "help_menu_g3LTEpin": "<b>Attention!</b><br /> <i>Operations presented on the page are available not for all models of 3G/LTE modems.</i> <br /> On the <b>PIN</b> page, you can change the PIN code of the identification card inserted to your 3G/LTE modem, disable or enable the check of the PIN code.",
    ...
    "reboot_for_correct": "For correct operation of the device will now reboot",
    "pingLabel": "Ping",
    ...
    "on": "On",
    "InvalidPortExist": "Port is busy",
    "GoToRemAcc": "Go to the edit page of the remote access?",
    "CommentVirtServ1": "Ports",
    "CommentVirtServ3": "Port",
    ...
    "pingDescText": "On the <b> Ping </b> page, you can check availability of a host from the local or global network via the Ping utility.",
    "air_wifiMacfilterError": "Unfortunately, you can not add more than 19 entries in a MAC-filter. Remove anything before you add a new rule.",
    "macfDescText_broadcom": "You can add, edit and delete addresses here<br><b><i>Note: You can add a maximum of 14 records</i></b>",
    "MessagePortUsed": "Check out the range of external ports. Some ports are already being used for remote access",
    ...
    "CommentVirtServ4": "used in the configuration for remote access to the device. You can not use it to configure the virtual server.",
    ...
    "menu_start_settings": "Quick Setup",
    "ruleID": "№",
    ...
    "ipfltRuleExists": "There is the same filter №",
    "CommentVirtServ2": "used in the configuration for remote access to the device. You can not use them to configure the virtual server.",
    ...
    "ntpTz10": "(GMT +10 h.) Vladivostok, Sakhalin, Magadan, Guam,  Khabarovsk Krai",
    ...
    "ntpTz6": "(GMT +6 h.) Omsk, Dhaka, Chittagong, Novosibirsk, Khulna",
    ...
    "ntpTz11": "(GMT +11 h.) Srednekolymsk, New Caledonia, Solomon Islands, Vanuatu",
    "help_ex_menu_flow_control": "To enable the flow control function, select the <b>Enabled</b> checkbox and click the <b>Apply</b> button. To disable the flow control function, deselect the <b>Enabled</b> checkbox and click the <b>Apply</b> button.",
    "routingAlreadyExists": "This route already exists",
    ...
    "tftp_ip": "DHCP option 66",
    "routingAlreadyExistsSave": "Some routes are repeated!",
    "menu_ntp": "System time",
    "wifiBroadcastEnable": "Enable",
    "airWiFi": "Сonfigure WiFi",
    "airVoip": "VoIP",
    "airVoipSettings": "Skip to VoIP settings",
    "InvalidPort": "Port wrong format",
    "netMacAddrInvalid": "MAC-address wrong format",
    "full_on": "Enable",
    "localIpIPv6": "Local IPv6-address",
    ...
    "airWiFiDesc": "Wireless network is not secure",
    "airVoipLine1": "Line 1",
    "addonBeamforming": "Enable TX Beamforming",
    "InvalidMask": "Subnet mask wrong format",
    "StartPortNotExist": "Starting port is not set",
    "full_off": "Disable",
    "remIpIPv6": "Remote IPv6-address",
    ...
    "addonIgmpDrop": "Drop multicast",
    "airNotWiFiConn": "Wi-Fi connection is not connected",
    "comment_logout": "Exit",
    "comment_reboot": "Reboot device",
    "clientConfTurnOn": "The search cannot be performed, as Wi-Fi is disabled. Enable Wi-Fi",
    "airVoipLine2": "Line 2",
    "StartPortLess": "End Port less than start port",
    "id": "ID",
    ...
    "help_menu_flow_control": "Flow Control On the <b>Flow Control</b> page, you can enable and disable data flow control for the WAN port of the router. This function is used for equal load balancing in ISPs' networks. Contact your ISP to clarify if this function needs to be enabled.",
    ...
    "dynpppoedesc": "A connection of this type is the combination of the Dynamic IP and PPPoE types. This type can be necessary when you need to configure access to your ISP’s LAN and the Internet access simultaneously.",
    ...
    "help_ex_menu_dlna": "<h3 class=\"help-title\">DLNA server settings:</h3> <table class=\"help-params\"> \t<tr> \t\t<td><b>Interval:</b></td> \t\t<td>A time period after which the server updates file information of the storage.</td> \t</tr> \t<tr> \t\t<td><b>Name:</b></td> \t\t<td>The server name displayed in the player.</td> \t</tr> \t<tr> \t\t<td><b>Folders:</b></td> \t\t<td>A list of folders with media content. The content type (video, music, images, miscellaneous) for every folder is also displayed.</td> \t</tr> </table>",
    "menu_flow_control_desc": "You can enable and disable data flow control for the WAN port of the router. This function is used for equal load balancing in ISPs' networks. Contact your ISP to clarify if this function needs to be enabled.",
    ...
    "telnetDescText": "On the <b>Telnet</b> page, you can enable or disable access to the device settings via TELNET from your LAN. By default, access is enabled.",
    ...
    "TR69Label": "TR-069 Client",
    "rem_port": "Remote port",
    "help_menu_ping_air_ipv6": "<br>On the <b>System / Ping</b> page, you can check availability of a host from the local or global network via the Ping utility.<br><br>     The Ping utility sends echo requests to a specified host and receives echo replies.<br><br>     To check availability of a host, enter the IP address or name of this host in the <b>Host</b> field, and select a number of requests that will be sent in order to check its availability from the <b>Count of packets</b> drop-down list. If availability check should be performed with IPv6, select the relevant checkbox. Click the <b>Start</b> button. After a while, the results will be displayed on the page.",
    "help_menu_telnet_air": "<br>On the <b>System / Telnet</b> page, you can enable or disable access to the device settings via TELNET from your LAN. By default, access is enabled.<br><br>     To disable access via TELNET, deselect the <b>On</b> checkbox and click the <b>Apply</b> button.<br><br> To enable access via TELNET again, select the <b>On</b> checkbox. In the <b>Port</b> field, enter the number of the router's port through which access will be allowed (by default, the port <b>23</b> is specified). Then click the <b>Apply</b> button.",
    "dlnaDescText": "On the <b>DLNA page</b>, you can enable the built-in DLNA server of the router to provide access to the USB storage for users of your LAN.<br> The built-in media server allows DLNA certified devices of your LAN to play multimedia content of the USB storage. Multimedia content can be played only when a USB storage is connected to the router.",
    "timestamp": "Remaining time",
    "lessmin": "less than a minute",
    "airRedirectIpConf": "The local IP address of the device was changed. Go to the new address?",
    "outOfRange": "address out of range",
    "help_menu_ftp_air": "<br>On the <b>USB storage / FTP</b> page, you can enable the built-in FTP server of the router to provide access to the USB storage for users of your LAN.<br><br> You can enable the FTP server only when a USB storage is connected to the router (in this case, the <b><i>Connected</i></b> value is displayed in the <b>USB storage</b> field). Select the <b>Enable</b> checkbox; if needed, change the router's port used by the FTP server in the <b>Port</b> field (by default, the standard port <b>21</b> is specified). Then click the <b>Apply</b> button.<br><br>     To allow access to the content of the USB storage for users of your LAN, proceed to the <b>System / Users</b> page and create needed accounts.<br><br>     To disable the built-in FTP server of the router, deselect the <b>Enable</b> checkbox and click the <b><i>Apply</i></b> button.",
    "help_menu_dlna_air": "<br>On the <b>USB storage / DLNA</b> page, you can enable the built-in DLNA server of the router to provide access to the USB storage for users of your LAN.<br><br>     The built-in media server allows DLNA certified devices of your LAN to play multimedia content of the USB storage. Multimedia content can be played only when a USB storage is connected to the router.<br><br> To enable the DLNA server, select the <b>Enabled</b> checkbox.<br><br>     In the <b>Update interval</b> field, specify the time period (in seconds), at the end of which the media server updates the file list of the USB storage, or leave the value specified by default (<b>900</b>). The minimal value you can specify is 60 seconds.<br><br>     In the <b>DLNA server name</b> field, specify a new name of the DLNA server for easier identification in your LAN or leave the value specified by default (<b>D-Link DLNA Server</b>). Use digits and/or Latin characters.<br><br>     To allow access to the content of the USB storage for users of your LAN, click the <b>Add</b> button. In the line displayed, locate a folder. To do this, click the button located to the right of the <b>Path</b> field (the button is available if the <b>Path</b> field is selected). In the opened window, double-click the icon of the storage or storage partition, select the needed folder in the directory structure, and click the <b>Open</b> button.<br><br>     For each folder you can define the type of files which will be available for users of your LAN. To do this, select the needed type of files from the <b>Type</b> drop-down list. To share all files of a folder, select the <b>All</b> value from the <b>Type</b> drop-down list.<br><br>     To undo the last changes, click the <b>Reset</b> button.<br><br>     After specifying the needed parameters, click the <b>Apply button</b>.<br><br>     To remove a folder from the list, select the checkbox in the line containing the relevant folder and click the <b>Apply</b> button.<br><br>     To disable the built-in DLNA server of the router, deselect the <b>Enabled</b> checkbox and click the <b>Apply</b> button.",
    "help_ex_menu_tr69": "The TR-069 client is used for remote monitoring and management of the device.<br> You can specify the following parameters:<br> <b>Interface</b> - The interface which the router uses for communication with the ACS. Leave the <b><i>automatic</i></b> value to let the device select the interface basing on the routing table or select another value if required by your ISP.<br> <b>Enable TR-069 Client</b> - Select the checkbox to enable the TR-069 client.<br> <b>Inform settings:</b><br> <b>Enable</b> - Select the checkbox so the router may send reports (data on the device and network statistics) to the ACS.<br> <b>Interval</b> - Specify the time period (in seconds) between sending reports.<br> <b>Auto Configuration Server settings:</b><br> <b>URL address</b> - The URL address of the ACS provided by the ISP.<br> <b>User name</b> - The username to connect to the ACS. The username can contain digits, Latin letters (uppercase and/or lowercase), and characters available on the keyboard.<br> <b>Password</b> - The password to connect to the ACS. The password can contain digits, Latin letters (uppercase and/or lowercase), and characters available on the keyboard.<br> <b>ConnectionRequest Settings:</b><br> <b>User name</b> - The username used by the ACS to transfer a connection request to the router. The username can contain digits, Latin letters (uppercase and/or lowercase), and characters available on the keyboard.<br> <b>Password</b> - The password used by the ACS. The password can contain digits, Latin letters (uppercase and/or lowercase), and characters available on the keyboard.<br> <b>Request port</b> - The port used by the ACS. By default, the port 8999 is specified.<br> <b>Request path</b> - The path used by the ACS.<br> When you have configured the parameters, click the <b><i>Apply</i></b> button.<br>",
    "help_ex_menu_samba": "You can enable the Samba server only when a USB storage is connected to the router (in this case, the <b><i>Connected</i></b> value is displayed in the <b>USB storage</b> field). To enable the Samba server, select the <b>Enable</b> checkbox.<br> The <b>Anonymous login</b> checkbox enables anonymous access to the content of the USB storage for users of your LAN. By default, the checkbox is selected.<br> If you want to provide authorized access to the content of the USB storage for users of your LAN, deselect the checkbox. After applying the parameters on this page, proceed to the <b>System / Users</b> page and create needed accounts.<br> In the <b>Workgroup field</b>, leave the value specified by default (<b>WORKGROUP</b>) or specify a new name of a workgroup which participants will have access to the content of the USB storage.<br> In the <b>NetBIOS</b> field, specify a new name of the USB storage for identification in your LAN. Use digits and/or Latin characters.<br> After specifying the needed parameters, click the <b>Apply</b> button.<br> To disable the built-in Samba server of the router, deselect the <b>Enable</b> checkbox and click the <b>Apply</b> button.",
    "min": "min",
    "macfltInvalidAddress": "Invalid address format",
    "help_menu_traceroute_air_ipv6": "<br>On the <b>System / Traceroute</b> page, you can define the route of data transfer to a host via the traceroute utility.<br><br>     To determine the route, enter the name or IP address of a host in the <b>Host</b> field. If the route should be determined using IPv6, select the relevant checkbox.  Click the <b>Start</b> button. After a while, the results will be displayed on the page.",
    "help_ex_menu_tranSettings": "On the <b>Transmission settings</b> page, you can configure all needed settings for the built-in Transmission client.<br> In the <b>Web-interface</b> page field, the address of the web-based interface of the Transmission client is displayed. To access the web-based interface of the Transmission client, click the link.<br> You can specify the following parameters:<br> <b>Enabled</b> - Select the checkbox to activate the Transmission client.<br> <b>Port</b> - The router's port which will be used by the Transmission client.<br> <b>Torrents directory</b> - The folder on the USB storage where files of the Transmission client will be stored.<br> <b>USB-storage path</b> - The name of the USB storage in the file system of the router. If the USB storage is divided into volumes, several values are displayed in the drop-down list.<br> <b>Web-interface port</b> - The port on which the web-based interface of the Transmission client is available.<br> <b>Open files limit</b> - The maximum number of files which clients can download simultaneously.<br> <b>Peer limit</b> - The maximum number of the service users from which you can download files.<br> <b>Authorization</b> - Select the checkbox if you want the Transmission client to request for username and password when accessing its web-based interface. Then fill in the <b>User name</b> and <b>Password</b> fields.<br> <b>User name</b> - The username to access the web-based interface of the Transmission client.<br> <b>Password</b> - The password to access the web-based interface of the Transmission client.<br> After specifying the needed parameters, click the <b>Apply</b> button.",
    "macfDescText": "You can add, edit and delete addresses here",
    "firmware_shortmsg": "Dear Customer! At the moment we are updating the firmware of your device. After update it will work more stable and efficient. Please do not power off the device before the firmware update is completed, this may cause a breakdown. Updating process will take 5-10 minutes.",
    "help_menu_tr69_air": "<br>On the <b>Advanced / TR-069 Client</b> page, you can configure the router for communication with a remote Auto Configuration Server (ACS).<br><br> The TR-069 client is used for remote monitoring and management of the device.<br><br>     You can specify the following parameters:<br>      <b>Interface</b> - The interface which the router uses for communication with the ACS. Leave the <b><i>automatic</i></b> value to let the device select the interface basing on the routing table or select another value if required by your ISP.<br><br>     <b>Enable TR-069 Client</b> - Select the checkbox to enable the TR-069 client.<br><br>     <b><i>Inform settings:</i></b><br><br>     <b>Enable</b> - Select the checkbox so the router may send reports (data on the device and network statistics) to the ACS.<br><br>     <b>Interval</b> - Specify the time period (in seconds) between sending reports.<br><br>     <b><i>Auto Configuration Server settings:</i></b><br><br>     <b>URL address</b> - The URL address of the ACS provided by the ISP.<br><br>     <b>User name</b> - The username to connect to the ACS. The username can contain digits, Latin letters (uppercase and/or lowercase), and characters available on the keyboard.<br><br>     <b>Password</b> - The password to connect to the ACS. The password can contain digits, Latin letters (uppercase and/or lowercase), and characters available on the keyboard.<br><br>     <b><i>ConnectionRequest Settings:</i></b><br><br>     <b>User name</b> - The username used by the ACS to transfer a connection request to the router. The username can contain digits, Latin letters (uppercase and/or lowercase), and characters available on the keyboard.<br><br>     <b>Password</b> - The password used by the ACS. The password can contain digits, Latin letters (uppercase and/or lowercase), and characters available on the keyboard.<br><br>     <b>Request port</b> - The port used by the ACS. By default, the port 8999 is specified.<br><br>     <b>Request path</b> - The path used by the ACS.<br><br>     When you have configured the parameters, click the <b><i>Apply</i></b> button.<br>",
    "config_aplly_ok_reboot": "The new configuration has been applied successfully. To apply changes, it is required to reboot the device. Reboot now?",
    "back_button_help_air": "« Back",
    "otherMacCaption": "Other mac-address",
    "macFilterRules": "Rules",
    "fwupdeteWarning": "Will update the software and reboot the device. Please do not power the device off. After reboot the page of the browser will be refreshed automatically. Continue?",
    "vserversStatusSnat": "NAT Loopback",
    "cloneMACReset": "Restore default MAC address",
    "ntpTz8": "(GMT +8 h.) Irkutsk, Australia, Brunei, Hong Kong",
    "ntpTz7": "(GMT +7 h.) Krasnoyarsk, Cambodia, Indonesia",
    "help_menu_traceroute_air": "<br>On the <b>System / Traceroute</b> page, you can define the route of data transfer to a host via the traceroute utility.<br><br>     To determine the route, enter the name or IP address of a host in the <b>Host</b> field. Click the <b>Start</b> button. After a while, the results will be displayed on the page.",
    "vserversEnableSnat": "Enable NAT Loopback",
    "help_menu_ping_air": "<br>On the <b>System / Ping</b> page, you can check availability of a host from the local or global network via the Ping utility.<br><br>     The Ping utility sends echo requests to a specified host and receives echo replies.<br><br>     To check availability of a host, enter the IP address or name of this host in the <b>Host</b> field, and select a number of requests that will be sent in order to check its availability from the <b>Count of packets</b> drop-down list. Click the <b>Start</b> button. After a while, the results will be displayed on the page.",
    "ipfltWrongPortOrRange3": "The source ports count differs from the destination ports count",
    "wpsWarning": "Before using the function you need to configure one of the following authentication types: <b>Open</b> with no encryption, <b>WPA2-PSK</b> , or <b>WPA-PSK/WPA2-PSK mixed</b> with the <b>AES</b> encryption method. ",
    "devInfoEmulVers": "Device emulator",
    "NetmaskErrorRealtek": "Netmask should not be less than 255.255.255.0",
    "help_menu_routing_ipv6": "<br>On the <b>Advanced / Routing</b> page, you can add static routes (routes for networks that are not connected directly to the device but are available through the interfaces of the device) into the system.<br><br> To create a new route, click the <b>Add</b> button. In the line displayed, you can specify the following parameters:<br><br> <b>Destination network</b> - A destination network to which this route is assigned.<br><br> <b>Destination netmask</b> - The destination network mask.<br><br> <b>Gateway</b> - An IP address through which the destination network can be accessed. The field is available when the <b><i>Auto</i></b> value is selected from the <b>Via Interface</b> drop-down list of this line.<br><br> <b>Metric</b> - A metric for the route. The lower the value, the higher is the route priority. <i>Optional</i>.<br><br> <b>Via Interface</b> - Select an interface through which the destination network can be accessed from the drop-down list. If you have selected the <b><i>Auto</i></b> value of this drop-down list, the router itself sets the interface on the basis of data on connected networks.<br><br> After specifying the needed parameters, click the <b>Apply</b> button.<br><br> To edit an existing route, select a needed field in the relevant line of the table, change its value, and click the <b>Apply</b> button.<br><br> To remove an existing route, select the checkbox located to the left of the relevant line in the table and click the <b>Apply</b> button.",
    "ntpTz4": "(GMT +4 h.) Baku, Samara, Tbilisi, Yerevan",
    "printServerWarning": "To operate the print server must be configured the client PC. For more information on how to configure the print-server can be found at <u>www.dlink.ru</u> section <b><i>FAQ</i></b>.",
    "help_menu_samba_air": "<br>On the <b>USB storage / Samba</b> page, you can enable the built-in Samba server of the router to provide access to the USB storage for users of your LAN.<br><br>     You can enable the Samba server only when a USB storage is connected to the router (in this case, the <b><i>Connected</i></b> value is displayed in the <b>USB storage</b> field). To enable the Samba server, select the <b>Enable</b> checkbox.<br><br>     The <b>Anonymous login</b> checkbox enables anonymous access to the content of the USB storage for users of your LAN. By default, the checkbox is selected.<br><br>     If you want to provide authorized access to the content of the USB storage for users of your LAN, deselect the checkbox. After applying the parameters on this page, proceed to the <b>System / Users</b> page and create needed accounts.<br><br>     In the <b>Workgroup field</b>, leave the value specified by default (<b>WORKGROUP</b>) or specify a new name of a workgroup which participants will have access to the content of the USB storage.<br><br>     In the <b>NetBIOS</b> field, specify a new name of the USB storage for identification in your LAN. Use digits and/or Latin characters.<br><br>     After specifying the needed parameters, click the <b>Apply</b> button.<br><br>     To disable the built-in Samba server of the router, deselect the <b>Enable</b> checkbox and click the <b>Apply</b> button.",
    "help_menu_transmission_air": "<br>On the <b>Transmission / Transmission settings</b> page, you can configure all needed settings for the built-in Transmission client.<br><br>  You can specify the following parameters:<br><br> <b>Enabled</b> - Select the checkbox to activate the Transmission client.<br><br> <b>Port</b> - The router's port which will be used by the Transmission client.<br><br> <b>Torrents directory</b> - The folder on the USB storage where files of the Transmission client will be stored.<br><br> <b>USB-storage path</b> - The name of the USB storage in the file system of the router. If the USB storage is divided into volumes, several values are displayed in the drop-down list.<br><br> <b>Web-interface port</b> - The port on which the web-based interface of the Transmission client is available.<br><br>  <b>Open files limit</b> - The maximum number of files which clients can download simultaneously.<br><br> <b>Peer limit</b> - The maximum number of the service users from which you can download files.<br><br> <b>Authorization</b> - Select the checkbox if you want the Transmission client to request for username and password when accessing its web-based interface. Then fill in the <b>User name</b> and <b>Password</b> fields.<br><br> <b>User name</b> - The username to access the web-based interface of the Transmission client.<br><br> <b>Password</b> - The password to access the web-based interface of the Transmission client.<br><br> After specifying the needed parameters, click the <b>Apply</b> button.<br><br>     In the <b>Web-interface</b> page field, the address of the web-based interface of the Transmission client is displayed. To access the web-based interface of the Transmission client, click the link.<br>",
    "adminPassword": "Administrator password",
    "hiddenNetworkComment": "Wireless network name (SSID) will not appear in the list of available wireless networks with customers. Go to a hidden network, you can connect to manually specify the SSID of the access point.",
    "urlfHTTPSWarning": "URL-filter is not designed to work with HTTPS-traffic. To block it, you can use IP-filters (go to the page \"<b>Firewall / IP-filters</b>\").",
    "passwDescText": "Administrator Password - password to login to the web interface (in the settings of the router)",
    "urlfAddrDescText": "You can add, edit and delete addresses here.<br> For example, to add to the url-filter's dlink.ru, in the input field, you can write \"dlink.ru\" or \"www.dlink.ru\"",
    "help_menu_users_air": "<br>On the <b>System / USB users</b> page, you can create user accounts to provide access to data on the USB storage connected to the router.<br><br>     To create a new user account, click the <b>Add</b> button.<br><br>     On the opened page, in the <b>Login</b> field, specify a username; in the <b>Password</b> and <b>Password confirmation</b> fields, specify a password for the account. For the username, you can use only digits; for the password, you can use letters of the Latin and Russian alphabets (uppercase and/or lowercase) and digits.<br><br>     <u>You cannot create accounts with the following usernames: <b>ftp, admin, support, user, nobody</b></u>.<br><br> To change the password of an account, select the relevant line in the table. On the opened page, enter a new value in the <b>Password</b> and <b>Password confirmation</b> fields, then click the <b>Apply</b> button.<br><br> To remove an account, select the checkbox located to the left of the relevant line in the table and click the <b>Delete</b> button.<br><br> To remove all accounts from this page, click the <b>Clear all</b> button (the button is displayed if at least one account exists).",
    "ntpTz12": "(GMT +12 h.) Petropavlovsk-Kamchatka, Anadyr, Fiji, Nauru, Tuvalu",
