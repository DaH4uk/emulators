...
*/
	...
	banner_code +='<a href="javascript:logout();"><div style="margin-top:13px;margin-left:250px;" class="titlebtn" align="center"><span>Logout</span></div></a>\n';          //chang margin-left 100->300
	...
	banner_code +='<span style="color:white">'+multiLanguage_all_array[multi_INT][2]+'</span>\n';
	banner_code +='<select name="select_lang" id="select_lang" class="input_option_lang" onchange="submit_language(this.value);">\n';    
	//banner_code +='<% shown_language_option(); %>';
 ...
 // banner_code +='<td valign="center" class="titledown" width="auto"><span id="firmver" class="time"></span></td>\n';
  ...
  banner_code +='<td width="730"></td><td><a id="helpAddress" href="help.html"><img src="images/icon/help.png" title="help" /></a></td>\n';// change width 17->450
...
tablink[0] = new Array("", "Setting_General.html", "Advanced_Wireless_Content.html", "Advanced_WWPS_Content.html", "Advanced_WMode_Content.html", "Advanced_ACL_Content.html", "Advanced_WSecurity_Content.html");
tablink[1] = new Array("", "Setting_BT.html", "Advanced_LAN_Content.html", "Advanced_DHCP_Content.html", "Advanced_GWStaticRoute_Content.html");
tablink[2] = new Array("", "Setting_NZB.html", "Advanced_QOSUserSpec_Content.html", "Advanced_PortTrigger_Content.html", "Advanced_VirtualServer_Content.html", "Advanced_Exposed_Content.html");
tablink[3] = new Array("", "Setting_amule.html", "Advanced_AiDisk_samba.html", "Advanced_AiDisk_ftp.html", "Advanced_HSDPA_others.html");
tablink[4] = new Array("", "Setting_FTP.html", "Advanced_URLFilter_Content.html", "Advanced_MACFilter_Content.html", "Advanced_Firewall_Content.html");
...
tablink[7] = new Array("", "QoS_EZQoS.html", "Main_TrafficMonitor_realtime.html", "Main_TrafficMonitor_last24.html", "Main_TrafficMonitor_daily.html");
...
menuL1_link = new Array("", "task.html", "as.html");     //add by alan
