...
function initializeItem(level, lastNode, leftSide)
{
  ...
  if (level>0)
    if (lastNode) //the last 'brother' in the children array
    {
      this.renderOb(leftSide + "<img src='images/joinbottom.gif' width=16 height=22>")//ftv2.gif
      leftSide = leftSide + "<img src='images/tblank.gif' width=16 height=22>"
    }
    else
    {
      this.renderOb(leftSide + "<img src='images/join.gif' width=16 height=22>") //ftv3.gif
      leftSide = leftSide + "<img src='images/ftv2vertline.gif' width=16 height=22>"
    }
  else
    this.renderOb("")
