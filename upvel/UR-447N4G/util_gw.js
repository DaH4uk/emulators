...
var language_file = 'language_ru.js';
var xmlhttp = getXmlHttp();
xmlhttp.open('GET', language_file, false);
xmlhttp.send(null);
...
function showtxrate_updated(form, band, wlan_id, rf_num)
{
 ...
 form.elements["txRate"+wlan_id].options[idx++] = new Option("home.htm"/*tpa=http://192.168.10.1/5.5M*/, "3", false, false);
