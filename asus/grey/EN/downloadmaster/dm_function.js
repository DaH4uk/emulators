...
function add_task(i){
	...
	else
	{
		...
		task_code +='<a id="showUP_n1'+j+'" href="Setting_NZB.html" style="display:none;"><img src="images/statusIcon/warning.png" alt="" /><span>'+multiLanguage_array[multi_INT][70]+'</span></a>\n';
		task_code +='<a id="showUP_n2'+j+'" href="Setting_NZB.html" style="display:none;"><img src="images/statusIcon/warning.png" alt="" /><span>'+multiLanguage_array[multi_INT][71]+'</span></a>\n';
		task_code +='<a id="showUP_n3'+j+'" href="Setting_NZB.html" style="display:none;"><img src="images/statusIcon/warning.png" alt="" /><span>'+multiLanguage_array[multi_INT][72]+'</span></a>\n';
...
function initial_Refresh_time(data){
	...
	if(location.host.split(":")[0] != initial_array[10]){
		if(initial_array[12] == 1 && location.host.split(":")[0]!="www.asusnetwork.net"){
		...
		else if(location.host.split(":")[0]=="www.asusnetwork.net"){
